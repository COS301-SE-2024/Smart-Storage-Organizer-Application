...
secret_name = os.environ.get('OPEN_SEARCH_SECRET_NAME')
region_name = os.environ.get('AWS_REGION', 'eu-north-1')
host = os.environ.get('OPEN_SEARCH_HOST', 'https://default-domain.eu-north-1.es.amazonaws.com')
index = os.environ.get('OPEN_SEARCH_INDEX', 'items')
