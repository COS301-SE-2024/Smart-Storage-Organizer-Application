...
def getSubCategoriesTotals(conn, curr,organozationid, ids,names,parentCategoryName):
...
def lambda_handler(event, context):
    ...
    try:
        ...
        for i,j in zip(ids, names):
            ...
            finalList.append(getSubCategoriesTotals(conn, curr,organozationid,subsId,subsName,j))
