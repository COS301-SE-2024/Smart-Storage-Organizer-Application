...
def lambda_handler(event,context):
    ...
    try:
        ...
        cur.execute(query,(body['changes'],body['changes_date_and_time'],body['changes_by'],body['related_record_id'],body['related_record_type'],body['related_record_name'],body['changes_type'],body['Reason_for_change'],body['organization_id'], json.dumps(body['previous']), 
