...
def lambda_handler(event,context):
    ...
    if 'changes' not in body or 'changes_date_and_time' not in body or 'change_by' not in body or 'related_record_id' not in body or 'related_record_type' not in body or 'related_record_name' not in body or 'changes_type' not in body or 'Reason_for_change' not in body or 'organization_id' not in body or 'previous' not in body or 'current' not in body:
        return {
            'statusCode': 400,
