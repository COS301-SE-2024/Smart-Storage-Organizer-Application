...
index='items'
region ='eu-north-1'
SE_host='search-search-o4zkwn3nnh7dh73ebndwbwz7ti.aos.eu-north-1.on.aws'
SE_password='MasterOs#ss1'
SE_Username='MasterUser1'
user_pool_id = 'us-east-1_EPbgIUMEQ'
# SE_region = os.getenv('Region') 
# SE_host = os.getenv('SEHost') 
# SE_index = os.getenv('Index')
