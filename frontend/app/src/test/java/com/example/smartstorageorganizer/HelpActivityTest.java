...
//    }
    ...
    public void testForgotPasswordLink() {
        onView(withId(R.id.help_reset_password_text_view))
                .perform(click());
        intended((Matcher<Intent>) allOf(
                (CompletableFuture<?>) IntentMatchers.hasComponent(ResetPasswordActivity.class.getName())
        ));
    }
    ...
    public void testHomepageLink() {
        onView(withId(R.id.help_add_category_text_view))
                .perform(click());
        intended((Matcher<Intent>) allOf(
                (CompletableFuture<?>) IntentMatchers.hasComponent(HomeActivity.class.getName())
        ));
    }
    ...
    public void testEditProfileLink() {
        onView(withId(R.id.help_edit_profile_text_view))
                .perform(click());
        intended((Matcher<Intent>) allOf(
                (CompletableFuture<?>) IntentMatchers.hasComponent(ProfileManagementActivity.class.getName())
        ));
    }
}