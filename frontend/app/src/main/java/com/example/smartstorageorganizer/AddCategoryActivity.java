                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    db.collection("category_requests").document(documentId)
                            ...
                            .addOnSuccessListener(aVoid -> {
                                ...
                                Utils.sendNotificationFromPhoneForUserRole("New Category Request  with name : "+categoryName+" has been made by "+app.getName()+app.getSurname(), "Add Category Request","Manager", "Add", app.getOrganizationID());
                                future.complete(true);
                            })
